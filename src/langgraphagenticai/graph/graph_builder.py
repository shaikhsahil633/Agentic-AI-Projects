...
from src.langgraphagenticai.nodes.chat_bot_with_Tool_node import ChatbotWithToolNode
...
class GraphBuilder:
    ...
    def chatbot_with_tools_builds_graph(self):
        """
    ...
    def setup_graph(self, usecase: str):
        ...
        if usecase == "Chatbot with Tool":
            self.chatbot_with_tools_builds_graph()
